import { Prisma, PrismaClient, LabelState, SourcePlatform } from '@prisma/client';
...
async function main() {
  ...
  const source = await prisma.source.upsert({
    ...
    create: {
      ...
      actorId: 'demo/actor',
      actorInputJson: { startUrls: ['https://facebook.com/groups/demo-group'] } as Prisma.InputJsonValue,
    },
  });
  ...
  for (const post of demoPosts) {
    await prisma.post.upsert({
      ...
      create: {
        ...
        rawPayloadJson: { seeded: true } as Prisma.InputJsonValue,
