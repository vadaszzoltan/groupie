...
import { LabelState, Prisma, ScrapeRunStatus, TriggerType } from '@prisma/client';
...
export class SourcesService {
  ...
  create(userId: string, dto: SourceDto) {
    return this.prisma.source.create({
      data: {
        ...dto,
        actorInputJson: dto.actorInputJson as Prisma.InputJsonValue,
        userId,
  ...
  async update(userId: string, id: string, dto: UpdateSourceDto) {
    ...
    return this.prisma.source.update({
      ...
      data: {
        ...dto,
        actorInputJson: dto.actorInputJson as Prisma.InputJsonValue | undefined,
      },
    });
  }
